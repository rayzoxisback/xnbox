...
public partial class TruckEntity : Prop, IUse
{
	...
	private TruckWheel frontLeft;
	private TruckWheel frontRight;
	private TruckWheel backLeft;
	private TruckWheel backRight;
	...
	public TruckEntity()
	{
		frontLeft = new TruckWheel( this );
		frontRight = new TruckWheel( this );
		backLeft = new TruckWheel( this );
		backRight = new TruckWheel( this );
	}
	...
	{
		base.Spawn();
		var mdl = "models/cars/Truck/truck";
		SetModel( mdl );
	...
	public override void ClientSpawn()
	{
...

		{
			...
			chassis_axle_front.LocalPosition = new Vector3( 3.4f, 0, 0.7f ) * 33.0f;
			clientModels.Add( chassis_axle_front );

			{
				wheel0 = new ModelEntity();
				wheel0.SetModel( "models/cars/Truck/truck_wheel" );
...

			{
				...
				wheel1.SetModel( "models/cars/Truck/truck_wheel" );
...

		{
			...
			chassis_axle_rear.LocalPosition = new Vector3( -2.55f, 0, 0.7f ) * 34.0f;
...

			{
				...
				wheel2.SetModel( "models/cars/Truck/truck_wheel" );
...

			{
				...
				wheel3.SetModel( "models/cars/Truck/truck_wheel" );
	...
	public void OnPrePhysicsStep()
	{
		...
		{
			var forwardSpeed = MathF.Abs( localVelocity.x );
			var speedFactor = truck_speed_divide - (forwardSpeed / 5000.0f).Clamp( 0.0f, 1.0f );
	...
	public bool OnUse( Entity user )
	{
		...
		{
			player.Vehicle = this;
			player.VehicleController = new TruckController();
			player.VehicleCamera = new TruckCamera();
